  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <br>
        <i>MB1 Spin-offs: <a href="{{site.baseurl}}{% link MB1A.md %}">MB1A</a>, <a href="{{site.baseurl}}{% link MB1B.md %}">MB1B</a>, <a href="{{site.baseurl}}{% link MB1G.md %}">MB1G</a>, <a href="{{site.baseurl}}{% link MB1L.md %}">MB1L</a>, <a href="{{site.baseurl}}{% link MB1N.md %}">MB1N</a>, <a href="{{site.baseurl}}{% link MB1T.md %}">MB1T</a></i>
      </div>
    </div>
    <div class="col-sm-12">
        <p>   </p>
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <br>
        <i>MB2 Spin-off: MB2P (link to come)</i>
      </div>
    </div>
    <div class="col-sm-12">
        <p>   </p>
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <br>
        <i>MB3 Spin-off: <a href="{{site.baseurl}}{% link MB3N.md %}">MB3-NIRS</a></i>
      </div>
    </div>
    <div class="col-sm-12">
        <p>   </p>
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        Do infants prefer agents who are seen to help over those who are seen to hinder?
        <br>
        <i>MB4 Spin-offs: MB4E (link to come), MB4I (link to come)</i>
      </div>
    </div>
    <div class="col-sm-12">
        <p>   </p>
