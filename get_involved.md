  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-10">
        ...
        <b>General MB Listserv:</b> <a href="{{ site.data.global.listserv.general }}"><i>Subscribe</i></a><br> 
        <b>General MB Slack:</b> <a href="{{ site.data.global.link.slack-invite }}"><i>Join workspace</i></a>
      </div>
    </div>
  </div>
  <br>
