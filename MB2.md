...
***
### Publications
Schuwerk, T.\*, Kampis, D.\*, (...) Frank, M., Rakoczy, R. (Stage 1 Registered Report). **Action anticipation based on an agent's epistemic state in toddlers and adults**. <i>(\* co-first authors)</i> PsyArXiv. [doi:10.31234/osf.io/x4jbm](https://doi.org/10.31234/osf.io/x4jbm) 
